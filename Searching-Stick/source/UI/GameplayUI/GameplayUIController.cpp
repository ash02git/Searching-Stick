...
namespace UI
{
	namespace GameplayUI
	{
        ...
        {
            search_type_text = new UI::UIElement::TextView();
            number_of_comparisons_text = new UI::UIElement::TextView();
            number_of_array_access_text = new UI::UIElement::TextView();
        ...
        void GameplayUIController::initializeButton()
        {
            menu_button->initialize("Menu Button",
                Global::Config::menu_button_large_texture_path,
        ...
        {
            search_type_text->initialize("Search Type  :  Linear Search", sf::Vector2f(search_type_text_x_position, text_y_position), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);
            number_of_comparisons_text->initialize("Comparisons  :  0", sf::Vector2f(comparisons_text_x_position, text_y_position), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);
            number_of_array_access_text->initialize("Array Access  :  0", sf::Vector2f(array_access_text_x_position, text_y_position), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);


            num_sticks_text->initialize("Number of Sticks  :  0", sf::Vector2f(num_sticks_text_x_position, text_y_pos2), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);


            delay_text->initialize("Delay  :  0 ms", sf::Vector2f(delay_text_x_position, text_y_pos2), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);


            time_complexity_text->initialize("Time Complexity  :  O(n)", sf::Vector2f(time_complexity_text_x_position, text_y_pos2), UI::UIElement::FontType::BUBBLE_BOBBLE, font_size);
        }
        ...
        {
            Gameplay::Collection::SearchType new_search_type = Global::ServiceLocator::getInstance()->getGameplayService()->getCurrentSearchType();
        ...
        {
            int number_of_comparisons = Global::ServiceLocator::getInstance()->getGameplayService()->getNumberOfComparisons();;
        ...
        {
            int number_of_array_access = Global::ServiceLocator::getInstance()->getGameplayService()->getNumberOfArrayAccess();;
        ...
        {
            int num_sticks = Global::ServiceLocator::getInstance()->getGameplayService()->getNumberOfSticks();
        ...
        {
            int delay_in_milliseconds = Global::ServiceLocator::getInstance()->getGameplayService()->getDelayMilliseconds();
        ...
        {
            sf::String time_complexity = Global::ServiceLocator::getInstance()->getGameplayService()->getTimeComplexity();
        ...
        void GameplayUIController::menuButtonCallback()
        {
            ...
            Global::ServiceLocator::getInstance()->getGameplayService()->reset();
